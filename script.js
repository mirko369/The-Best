...
const drinks = {
  ...
  tequila: {
    ...
    price: ["3,30 Є / 25,00 kn", "6,60 Є / 50,00 kn", "8,00 Є / 60,00 kn"],
  },
  cognac: {
    name: [
      "Hennessy",
  ...
  dessert: {
    ...
    price: ["2,70 Є / 20,00 kn", "3,30 Є / 25,00 kn", "3,30 Є / 25,00 kn"],
  },
  sparkling: {
    name: [
      "Pjenušac",
  ...
  extras: {
    ...
    price: ["0,70 Є / 5,00 kn", "0,70 Є / 5,00 kn", "0,40 Є / 3,00 kn"],
  },
  bottle: {
    name: [
  ...
  cocktails: {
    ...
    price: ["6,60 Є / 50,00 kn", "4,00 Є / 30,00 kn"],
  },
};
